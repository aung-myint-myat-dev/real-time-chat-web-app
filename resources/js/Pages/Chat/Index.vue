...
defineEmits(['selectChat', 'selectSearchUser', 'cancelSearchUser'])
    ...
    <div class="w-full h-full relative flex flex-col gap-2 border-r border-border-color">
        ...
        <div v-if="searchResult && searchResult.length > 0">
            <div class="flex items-center justify-between p-2">
                ...
                <button class="cursor-pointer" @click="cancleSearch">
                    <X size="20" />
                </button>
            </div>
            <div class="flex flex-col gap-2 p-2">

                <button v-for="user in searchResult" :key="user.id" @click="$emit('selectSearchUser', user)"
